<?php
$recipient_email    = "sachin.studiomars@gmail.com"; //recepient
$from_email         = "sachin.studiomars@gmail.com"; //from email using site domain.
...
if($_POST){
   ...
   // if(strlen($subject)<3){ //check emtpy subject
    ...
    $boundary = md5("trocko.in"); 
    
	//construct a message body to be sent to recipient
	$message_body =  "You have received a career enquiry. Please find the below mentioned details.\n";
	//$message_body .=  "------------------------------\n";
	$message_body .=  "Name: $sender_name\n";
	//$message_body .=  "------------------------------\n";
	$message_body .=  "Contact No. $phone_number\n";
