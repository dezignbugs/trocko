<?php 
	...
	if(!isset($userName) || trim($userName) == '' || !isset($userEmail) || trim($userEmail) == '' || !isset($userContact) || trim($userContact) == '' || !isset($content) || trim($content) == '')
		{
											...
											<tr>
												<td align="left" valign="top" bgcolor="#FFFFFF">
													<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size: 18px; line-height: 28px; text-align: left;">
														<tbody>
															<tr>
																<td align="right" valign="top"><img src="http://trocko.in/demo1/images/logo.png"  alt="TROCKO"/></td>
															</tr>
															<tr>
																<td>
															...
															<tr>
																<td style="padding-left:23px; padding-right:23px;">
																	...
																	<p style="margin-bottom:5px; margin-top:0px;">You have received a contact enquiry. Please find the below mentioned details.</p>
																</td>
															</tr>
															<tr>
																...
																<td>
																	<table border="0" align="left" cellpadding="0" cellspacing="0" style="font-size:18px;">
																		<tbody>
																			...
																			<tr>
																				<td align="right" style="padding:5px 23px 5px 23px; vertical-align:top;"><strong>Message</strong></td>
																				<td style="padding:5px 23px 5px 23px; line-height:28px;">'.$content.'</td>
																			</tr>
																		</tbody>
																	</table>
																</td>
																...
																<td>
																	<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top:29px; margin-bottom:25px; padding-bottom:20px; border-bottom:1px solid #d7d7d7;">
																		<tbody>
																			<tr>
																			  <td style="font-size:24px;padding-left:23px;" align="left" valign="top">&nbsp;</td>
																			  <td style="font-size:21px;" align="right" valign="top"><img src="http://trocko.in/demo1/images/logo.png"  alt="TROCKO"/></td>
																		  </tr>
																			<tr>
																			  <td style="font-size:24px;padding-left:23px;" align="left" valign="top">&nbsp;</td>
